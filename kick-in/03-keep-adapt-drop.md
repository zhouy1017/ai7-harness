...
| Tiered GitHub Actions verification ladder | **Accepted: keep and rebaseline** | Focused/PR/nightly-or-release tiers chosen for the new topology, with exact-head evidence | Preserve the tiered workflow principle without freezing old workflow names or commands. |
