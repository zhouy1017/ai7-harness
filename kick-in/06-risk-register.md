...
| ~~“Full Harness” exposes shell/filesystem/network powers to unpublished editorial material outside the intended task~~ **Addressed at Question 29** | — | Full engine, narrow tool surface: no generic shell, roaming filesystem, or arbitrary network in an editorial Run. Agent Data Root as OS sandbox with Run Source Scope nested inside; separate Editorial and Developer profiles with no self-service escalation. ADR 0017 |
