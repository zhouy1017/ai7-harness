...
28. [Repository development dispatch](./27-repository-development-dispatch.md) — current Question 25/ADR 0059 three-role model with fixed Codex bindings, fresh Issue-bound Task attempts, two-stage receipts, and query-driven coordination.
