...
28. [Repository development dispatch](./27-repository-development-dispatch.md) — current Question 25/ADR 0060 three-role model with fixed Claude Code bindings, fresh Issue-bound Task Sessions, two-stage receipts, and query-driven coordination.
