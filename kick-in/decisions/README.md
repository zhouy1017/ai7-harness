...
- [ADR 0023: Ship portable and installer channels with a self-contained data root](../../docs/adr/0023-portable-release-with-self-contained-data-root.md)
...
- [ADR 0027: Support Windows and macOS as one AI7 product](../../docs/adr/0027-support-windows-and-macos-as-one-product.md)
