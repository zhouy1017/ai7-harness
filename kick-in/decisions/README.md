...
Accepted and explicitly superseded system-wide decisions live under [`docs/adr/`](../../docs/adr/). The current root sequence contains 62 records, ADR 0001 through ADR 0062:
