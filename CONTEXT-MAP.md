...
- [Active policy set v4](./docs/policies/active-policy-set.v4.json) — the closed trusted scope map and exact version/path/SHA-256 pins for Provider Processing v1/v2/v3/v4 plus unchanged External Export v1; it also corrects the `ordinary-production` v3 pin its predecessor carried. Immutable [active-set v1](./docs/policies/active-policy-set.v1.json), [v2](./docs/policies/active-policy-set.v2.json) and [v3](./docs/policies/active-policy-set.v3.json) remain byte-preserved predecessor history. [`docs/policies/README.md`](./docs/policies/README.md) owns target qualification, artifact routes, and validation.
