...
async function runAccessibilityJourney(renderer) {
  ...
  // reads it as it reads a caret the reader places. The focus that enters the text then finds it there.
