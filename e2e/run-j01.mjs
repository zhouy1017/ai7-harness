...
async function runJourney(
  ...
  await assertRenderer(
    renderer,
    `typeof globalThis.process === 'undefined' && typeof globalThis.require === 'undefined' && Object.keys(window.ai7).sort().join(',') === 'abandonImportDraft,acceptReimportDegradation,acknowledgeImportCompletion,applyChangeSuggestion,applyChangeSuggestionBatch,approveManuscriptExport,authorizeBaselineAnalysis,authorizeReviewRun,authorizeTaskAuthorization,cancelServiceJob,cancelWaitingBaselineAnalysis,chooseManuscriptExportDestination,commitBookCreation,commitManuscriptReimport,commitNewBookImport,commitReplacement,commitSourceImport,continueImportDraft,continueReviewRun,createEditorialMark,deferRecovery,designatePublicationVersion,dismissReplacementPreview,enableEditorialWorkspaceProfile,flushJournalEdit,freezeReplacement,generateReviewReport,getBookOverview,getBookWorkbenchRoute,getEditorialMarkCard,getHistoricalRevision,getImportStartup,getManuscriptApplyOutcome,getManuscriptRail,getManuscriptWindow,getManuscriptWindowAt,getModelServiceSettings,getOutline,getProductDataLocation,getRecoveryComparison,getReimportIdentityCandidatePage,getReimportLineageSourceVersionPage,getReimportMappingPage,getSearchResults,getStartup,inspectBaselineAnalysis,inspectDeliverables,inspectEditorialWorkspaceProfile,inspectForegroundExecutionBoundary,inspectGlobalAttention,inspectProposalConflict,inspectReviewFindingOfMark,inspectReviewWorkspace,inspectTaskAuthorization,inspectTaskPlan,installEditorialWorkspaceProfile,leaveBookWorkbench,listBooks,listPriorWork,openBookWorkbench,platform,pollServiceJob,prepareBaselineAnalysis,prepareBookCreation,prepareManuscriptReimport,prepareNewBookReview,prepareReplacement,prepareReviewRun,prepareSourceImportReview,prepareTaskAuthorization,recordChangeSuggestionDecision,recordManuscriptEntryPosition,recordProposalDecisionReason,recordReviewFindingDisposition,redoManuscript,removeModelServiceCredential,reselectImportDraft,resolveProposalConflict,resolveReimportMapping,restoreRecovery,revealManuscriptExport,revealProductDataLocation,reverseAppliedChangeSuggestion,reviewManuscriptExport,runEditorClipboardCommand,runReconnectPreflight,saveMilestone,saveModelServiceCredential,saveProposalConflictDraft,selectAndStageManuscript,startBaselineAnalysisWhenOnline,startReplacementCommit,startSearch,undoManuscript,updateEditorialMark,viewRecoveryCandidate'`,
    'renderer-isolation',
  );
  await assertRenderer(
    renderer,
