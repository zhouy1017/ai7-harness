...
async function recoverSyntheticCredentialCleanupState(dataRoot, runRoot) {
  ...
  try {
    ...
    // (`PRODUCTION_DOCUMENT_DELIVERY_SCHEMA_VERSION` since Issue #415, S66b). It read 19 until #467 — one revision
