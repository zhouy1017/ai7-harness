...
The current J-01 scenario still generates its public-synthetic Chinese DOCX under an external disposable temp root at runtime and does not use `SampleBooks/`. The accepted next compatibility baseline is exact [`SampleBooks/sample1.docx`](SampleBooks/sample1.docx), 29,550 bytes with SHA-256 `b8a3dbde0aa8a1ec7265f9ae3fe47877759e7947c5ab69682cd0a8f424a8d483`, under [ADR 0044](docs/adr/0044-use-sample1-as-compatibility-and-recording-baseline.md); current implementation remains synthetic until the separately revised Issue #36 lands.
