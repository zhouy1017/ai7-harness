...
const EDITABLE_IMPORT_REFUSAL_REASONS: Readonly<Record<Exclude<SourceFormat, 'DOCX'>, string>> = {
  PDF: 'PDF 为固定版式，没有可靠的可编辑往返；可作为来源材料保留。',
  DOC: '旧版 Word（.doc）的本地转换尚未提供；可作为来源材料保留。',
  TXT: '纯文本与 Markdown 的本地转换尚未提供；可作为来源材料保留。',
  MD: '纯文本与 Markdown 的本地转换尚未提供；可作为来源材料保留。',
...
/**
 * Only a DOCX becomes an editable Manuscript in this unit; every other format states its reason and
 * is offered source-only retention instead (ADR 0072 §2, V2-UX-IMP-006).
 */
