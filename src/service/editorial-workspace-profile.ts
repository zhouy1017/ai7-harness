...
import { EDITORIAL_MARK_SCHEMA_VERSION, EDITORIAL_REVIEW_SCHEMA_VERSION, PUBLICATION_VERSION_SCHEMA_VERSION, PROPOSAL_CONFLICT_SCHEMA_VERSION, IMPORT_RETENTION_SCHEMA_VERSION, IMPORTED_MARK_SCHEMA_VERSION, EXPORT_LEDGER_SCHEMA_VERSION, CONNECTIVITY_WAIT_SCHEMA_VERSION, DEFAULT_EXECUTION_RULE_SCHEMA_VERSION, RUN_CANCELLATION_SCHEMA_VERSION, MANUSCRIPT_EFFECT_SCHEMA_VERSION, J03_TASK_AUTHORIZATION_SCHEMA_VERSION, J04_BASELINE_ANALYSIS_SCHEMA_VERSION, MANUSCRIPT_ENTRY_POSITION_SCHEMA_VERSION, MANUSCRIPT_INTAKE_SCHEMA_VERSION, SUCCESSIVE_TASK_SCHEMA_VERSION, TASK_AUTHORIZATION_SCHEMA_VERSION, TEXT_CONVERSION_SCHEMA_VERSION, FACTUAL_REVIEW_SCHEMA_VERSION } from './task-authorization.js';
