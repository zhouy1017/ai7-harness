...
| **I-07** | Each deliverable owns workflow state; gates, review, signoff, delivery, export, and public release retain separate authority and proof. |
...
Window chrome, menus, shortcuts, file pickers, installation flow, data-path presentation, secret-store prompts, font fallback, and CPU artifact may vary when the same AI7 command, record transition, authority, fidelity, privacy, recovery, and accessibility outcome remains.
