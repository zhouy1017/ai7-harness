...
| [U-R](#source-registry) `UX-WF-006`; [U-T](#source-registry) | [C-ED](#source-registry) `Delivery Package`; [C-07](#source-registry); [C-08](#source-registry) | S | Exact deliverable revision, required artifacts, Signoff Records, destination, and release/export authority are shared. Missing-requirement and final-receipt presentation is candidate projection; any receipt must link its independent Effect record rather than become a package-owned field. |
...
| `J-07` workflow and delivery | [C-ED](#source-registry) `Editorial Deliverable` through `Delivery Package`; [C-EX](#source-registry) `Domain Command` / `External Export Policy` / Effects; [C-07](#source-registry); [C-08](#source-registry); [C-17](#source-registry). | Destination chooser, file/share dialog, phase-view layout. | Technical execution completion is not workflow completion, signoff, Effect proof, or release authority; Review Decision/signoff/export is not factual truth or public-release authority. |
