...
> Amended by [ADR 0084](./0084-admit-the-legacy-doc-to-the-background-test-guests-for-j-01.md): "The E2E inputs remain public synthetic material or admitted Public SampleBooks" has one exception, J-01's `doc-manuscript` scenario where the local-only legacy `.doc` is held. Its full-fidelity artifacts may render that manuscript's content; they stay under ignored `test-results/` and the runner's results directories, and no agent opens, quotes or uploads them.
