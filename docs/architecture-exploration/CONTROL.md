...
3. Run final exact-head Standards and Spec review, confirm the invariant list if both pass, and present only the decision-ready platform consistency choices to the owner.
