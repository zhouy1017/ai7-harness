...
2. Keep all three stopped A1 Workers read-only at amended candidate head `92d1089c0ee278d141ec752d98c0e25c2e5a2df5`; there is no active writer.
3. Finish renewed independent exact-head Standards and Spec review, resolve any bounded finding through a new exclusive brief if needed, then confirm the invariant list and present only the decision-ready platform consistency choices to the owner.
