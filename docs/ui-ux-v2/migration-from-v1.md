...
| Standalone AI7 Workflow Profile definition owner | Retain AI7 Workflow Profile only as a product projection/selector over an exact native DSH definition carrier; AI7 still owns durable Workflow Instances, phases, Gates, Signoffs and business transitions. Exact carrier mapping remains deferred. |
