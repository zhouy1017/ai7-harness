...
- [ADR 0076](../adr/0076-align-editor-facing-surfaces-to-the-owner-s-september-decisions.md) (2026-09-09) aligns the editor-facing surfaces to the Owner's design-session decisions — manuscript-first entry, marks, review, evaluation, knowledge base, findings center, external evidence retention — and names every clause it changes. The per-screen execution standard is [`editor-surfaces.md`](./editor-surfaces.md) (ADR 0077); there is no separate handoff document.
...
- [ADR 0078](../adr/0078-align-the-remaining-references-the-plan-and-the-tracker-to-the-editor-facing-specification.md) (2026-09-10) aligns the remaining references, the development plan and the tracker to the specification and names the clauses it re-reads or rewrites.
