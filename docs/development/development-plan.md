...
| 1c.5 | S50 | #311 | T2 | J-01, J-04, J-12 | Test manuscripts composed from admitted SampleBook content rather than invented text | #352 | integrated (PR #365, `dev@55299e40`); J-08's conversion is #360 |
| 1c.6 | S51 | #313 | T3 | J-01 | Multi-format manuscript intake normalizing to DOCX, with the Source Version always keeping the original | #297 | split into four units on the Issue under ADR 0072: S51a #352 integrated (PR #357, `dev@1c5168fc`); S51b-1 #350 (format routing, source-only retention of any recognised file, schema 18; T3) in flight (attempt A1 on Brief revision 2: the rename moved to #363, schema 18 declared in four modules); #363 (T1) renames the intake path after #350 and #311; then S51b-2 #356 (`.txt` / `.md` conversion), S51c #351 (the `.doc` converter) |
