...
Status: **frozen design reference as of `dev@4c50ce31b0f15ff2bfadd2af17fc914c317e0f22` under [ADR 0064](../../adr/0064-reweight-repository-development-toward-value-first-delivery.md); canonical Execution context; term definitions change only through an ADR that names the clause**
...
_Target-qualified accepted route_: [`external-export-policy.v2.json`](../../policies/external-export-policy.v2.json), with its [policy-specific schema](../../policies/external-export-policy.v2.schema.json), [human projection](../../policies/external-export-policy.v2.md), and its exact [active-set v5 pin](../../policies/active-policy-set.v5.json), selected under [ADR 0079](../../adr/0079-record-the-owner-s-decisions-of-2026-09-10-on-storage-policies-export-egress-providers-and-samplebooks.md) §3; the immutable [v1](../../policies/external-export-policy.v1.json) remains predecessor history. Its internal `lifecycleStatus: "active"` is repository-current/canonical only at an exact integrated `dev` commit where that same-tree pin matches identity, version, path, and SHA-256; elsewhere it is `accepted-but-unintegrated`.
