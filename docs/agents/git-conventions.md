...
- The Reviewer's schema-v5 Launch and Return Receipts record `reviewed_head` and whether its binding matched the reviewed class. A verdict never becomes a pull-request, CI, branch, exact-head, zero-finding, or re-review gate.
