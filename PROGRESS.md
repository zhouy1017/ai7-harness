...
- Complete the final exact-head read-only review, then transition #180 Ready exactly once and monitor the one changed-head paired-platform Gate. Any Journey/platform failure returns the PR to Draft with no unchanged rerun; exact Windows and macOS success permits squash integration.
