...
/**
 * The relations schema revisions 37 to 50 add (Issue #415, S66a to S66c; Issue #416, S67a and S67b; Issue #547; Issue #426,
 * S68a; Issue #431, S83; Issue #427, S79a and S79c; Issue #429, S81a; Issue #94, S38; Issue #61, S26a and S26b), in drop order:
 * the Learning Eligibility decisions (revision 50), the Proposal Decisions' feedback (revision 49), the analysis feedback signals (revision 48), the Evaluation Records' entries and the records (revision 47), the 资料库 items' decisions and the items (revision 46),
...
/** Drop the relations revisions 37 to 50 added, foreign keys off around it. The caller sets the version. */
