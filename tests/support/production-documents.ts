...
/** The relations revisions 37 to 57 add that a migration leaves empty: all but the store's version record. */
...
/** Drop the relations revisions 37 to 57 added, foreign keys off around it. The caller sets the version. */
