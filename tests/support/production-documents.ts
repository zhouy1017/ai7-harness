...
/**
 * The relations schema revisions 37 to 40 add (Issue #415, S66a to S66c; Issue #416, S67a), in drop order: a document's
 * phase moves and workflow instance (revision 40), the Book's 图书交付包 versions, which name documents' deliveries, then
 * a document's Delivery Records, decisions and versions before the document. A suite that plants a store at an earlier revision drops them with whatever
...
/** Drop the relations revisions 37 to 40 added, foreign keys off around it. The caller sets the version. */
