...
/**
 * The relations schema revisions 37 to 43 add (Issue #415, S66a to S66c; Issue #416, S67a and S67b; Issue #547; Issue #426,
 * S68a), in drop order: the 维护事项 of each 发稿版本 (revision 43), how a document's origin material was read (revision
 * 42), a package's exports and their files (revision 41), a document's phase moves and workflow instance (revision 40), the
 ...
 * added: a store that old never held them. Revision 37 also rebuilt `manuscripts`; a planted store keeps the rebuilt
 * relation and its partial index, which every earlier revision's validation accepts, exactly as a store an earlier build
 * planted after this one would hold them.
 */
...
/** Drop the relations revisions 37 to 43 added, foreign keys off around it. The caller sets the version. */
