...
// stays far below the few-hundred-block ceiling this layer works with. Exact `sample1`, the one
// admitted Public SampleBook, is enough, because size is not this suite's subject; its content is.
